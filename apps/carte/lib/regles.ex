defmodule Regles do
  ...
  @doc """
  Retourne une version condensée du jeu. (Cela permet de ne pas envoer des message de 4Ko)
  """
  @callback condensee(struct(), integer()) ::map()
  ...
  @doc """
  Retourne la liste des coups possible pour un joueur donnée
  """
